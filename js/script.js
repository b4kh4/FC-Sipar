...
const newsData = [
    {
        title: "🔥 Сипар завоевал бронзовые медали Суперлиги РТ",
...
// Анимация счетчика побед
const winsCounter = document.getElementById('wins-count');

// window.addEventListener('DOMContentLoaded', () => {
//     let currentCount = 0;
//     let target = Number(winsCounter.innerHTML);
...
//         }
//         winsCounter.textContent = currentCount;
//     }, 60);
// });
